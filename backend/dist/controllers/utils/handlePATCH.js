...
const handlePATCH = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { _id: BookForUpdateID } = req.body;
    const bookToFind = yield Book_1.default.findOne({ _id: BookForUpdateID }).lean();
    ...
    const updating = Object.assign(Object.assign({}, req.body), { editedAt: new Date().toISOString() });
    yield Book_1.default.findOneAndUpdate(filter, updating);
